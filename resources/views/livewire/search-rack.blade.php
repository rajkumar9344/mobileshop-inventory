            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="input-group">
                        ...
                        <input wire:keydown.escape="resetQuery" wire:model.live.debounce.500ms="query" type="text" class="form-control" placeholder="Type rack name or id....">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="list-group list-group-flush">
                        @foreach($search_results as $result)
                            <li class="list-group-item list-group-item-action">
                                <a wire:click="resetQuery" wire:click.prevent="selectRack({{ $result }})" href="#" class="d-block">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <strong>{{ $result->rack_name }}</strong><br>
                                            <span style="font-size: 16px;" class="text-muted">Code: {{ $result->rack_id }}</span>
                                        </div>
                                        <div class="col-md-6 text-right">
                                            <span style="font-size: 16px;">Identifier: {{ $result->rack_id }}</span>
                                        </div>
                                    </div>
                                </a>
                            </li>

        ...
        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button"
           aria-haspopup="true" aria-expanded="false">
            <div class="c-avatar mr-2">
                ...
                @else
                    <img class="c-avatar rounded-circle" src="/default-avatar.png" alt="Profile Image">
                @endif
            </div>
            <div class="d-flex flex-column">
                    ...
                    @else
                        ...
                        <span class="font-italic">Offline <i class="bi bi-circle-fill text-secondary" style="font-size: 11px;"></i></span>
                    @endif
            </div>
        </a>

            ...
            <table class="banner-table">
                <tr>
                    <td class="company-details">
                        ...
                        <div class="subtitle">{{ settings()->company_tagline ?? 'Report from our company' }}</div>
                    </td>
                    <td class="invoice-meta">
                        <div class="label">Ledger Report</div>
                        <div class="ref">{{ \Carbon\Carbon::now()->format('d/m/Y h:i A') }}</div>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="body">
            ...
            <div class="message">
                @if(!empty($messageBody))
                    <p style="margin:0 0 8px 0">{!! nl2br(e($messageBody)) !!}</p>
                @else
                    <p style="margin:0">Attached is the requested ledger report. You can download the PDF attachment for your records.</p>
                @endif
            </div>
        </div>

...
class PurchasesReceiptsDataTable extends DataTable
{
    ...
    protected function getColumns() {
        return [
            ...
            Column::computed('supplier')->title('Name')->orderable(false)->className('text-center align-middle'),
            ...
            Column::computed('action')->exportable(false)->printable(false)->orderable(false)->className('text-center align-middle'),

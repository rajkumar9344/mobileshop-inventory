...
<head>
    ...
    <title>Purchase Bill - {{ $purchase->reference }}</title>
    <style>
    ...
    <div class="card">
            ...
            <table class="banner-table">
                <tr>
                    <td class="company-details">
                        ...
                        <div class="subtitle">{{ settings()->company_tagline ?? 'Purchase bill from our company' }}</div>
                    </td>
        ...
        <div class="body">
            <div style="text-align:center; margin-bottom:8px;">
                ...
                <div style="font-weight:700">{{ \Carbon\Carbon::parse($purchase->date)->format('d/m/Y h:i A') }}</div>
            </div>
            ...
            <table class="cols-table">
                <tr>
                    ...
                    <td>
                        ...
                        <div class="muted">{{ $supplier->supplier_name }}</div>
                        <div class="muted">{{ $supplier->address }}</div>
                        <div class="muted">Email: {{ $supplier->supplier_email }}</div>
                        <div class="muted">Phone: {{ $supplier->supplier_phone }}</div>
                    </td>
                </tr>
            </table>

            <div class="message">
                <p style="margin:0 0 8px 0">Hello {{ $supplier->supplier_name }},</p>

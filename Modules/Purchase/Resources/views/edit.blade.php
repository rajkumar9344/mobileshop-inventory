                            ...
                            <div class="form-row mt-2 mb-3">
                                ...
                                <div class="col-md-2 pr-1">
                                    ...
                                    <select class="form-control" name="purchase_type" id="purchase_type" onchange="Livewire.dispatch('purchaseTypeChanged', {type: this.value})" @if($isReadOnly) disabled @endif>
                                        <option value="1" {{ ($purchase->purchase_type ?? 1) == 1 ? 'selected' : '' }}>Type 1</option>
                                        <option value="2" {{ ($purchase->purchase_type ?? 1) == 2 ? 'selected' : '' }}>Type 2</option>
                                        <option value="3" {{ ($purchase->purchase_type ?? 1) == 3 ? 'selected' : '' }}>Type 3</option>
                                        <option value="4" {{ ($purchase->purchase_type ?? 1) == 4 ? 'selected' : '' }}>Type 4</option>
                                    </select>
                                </div>
                            </div>
                            </div>

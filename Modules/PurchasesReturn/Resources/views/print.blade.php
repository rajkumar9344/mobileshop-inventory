...
<div class="pdf-container">
    ...
    <table class="info-table">
        <tr>
            ...
            <td width="34%">
                ...
                <div>Status: <strong>{{ $purchase_return->status }}</strong></div>
    ...
    <table class="totals-table">
        <tr>
            <td><strong>Discount ({{ $purchase_return->discount_percentage }}%)</strong></td>
            <td>{{ format_currency($purchase_return->discount_amount) }}</td>
        </tr>
        <tr>
            <td><strong>Tax ({{ $purchase_return->tax_percentage }}%)</strong></td>
            <td>{{ format_currency($purchase_return->tax_amount) }}</td>
        </tr>
        <tr>
            <td><strong>Shipping</strong></td>
            <td>{{ format_currency($purchase_return->shipping_amount) }}</td>
        </tr>
        <tr>
            <td><strong>Grand Total</strong></td>
            <td><strong>{{ format_currency($purchase_return->total_amount) }}</strong></td>
        </tr>
    </table>
    <div class="footer">

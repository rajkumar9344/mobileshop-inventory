            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex flex-wrap align-items-center">
                        ...
                        <div class="ml-auto">
                            <a href="{{ route('purchase-returns.index') }}" class="btn btn-sm btn-outline-secondary mr-2">
                                <i class="bi bi-arrow-left"></i> Back
                            </a>
                            <a target="_blank" class="btn btn-sm btn-secondary mr-2 d-print-none" href="{{ route('purchase-returns.pdf', $purchase_return->id) }}">
                                <i class="bi bi-printer"></i> Print
                            </a>
                            <a target="_blank" class="btn btn-sm btn-info d-print-none" href="{{ route('purchase-returns.pdf', $purchase_return->id) }}">

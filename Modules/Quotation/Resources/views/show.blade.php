            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex flex-wrap align-items-center">
                        ...
                        <div class="ml-auto">
                            <a href="{{ route('quotations.index') }}" class="btn btn-sm btn-outline-secondary mr-2">
                                <i class="bi bi-arrow-left"></i> Back
                            </a>
                            <a target="_blank" class="btn btn-sm btn-secondary mr-2 d-print-none" href="{{ route('quotations.pdf', $quotation->id) }}">
                                <i class="bi bi-printer"></i> Print
                            </a>
                            <a target="_blank" class="btn btn-sm btn-info d-print-none" href="{{ route('quotations.pdf', $quotation->id) }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-4 mb-3 mb-md-0">
                                ...
                                @else
                                    ...
                                    <div>{{ $quotation->contact_address }}</div>
                                    <div>Email: {{ $quotation->contact_email }}</div>
                                    <div>Phone: {{ $quotation->contact_phone }}</div>
                                @endif
                            </div>
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            ...
                                            <span class="badge badge-success">
                                                {{ $item->productCode->code ?? $item->product_code }}
                                            </span>
                                        </td>

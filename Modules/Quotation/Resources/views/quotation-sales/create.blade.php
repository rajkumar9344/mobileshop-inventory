    ...
    <script>
        $(document).ready(function () {
            ...
            $('#getTotalAmount').click(function () {
                var total = {{ Cart::instance('sale')->total() }} || 0;
                var displayEl = document.getElementById('paid_amount');
                if (displayEl) {
                    var formatted = parseFloat(String(total)).toFixed(2);
            ...
            $('#sale-form').submit(function () {
                // x-currency-input keeps a hidden numeric field in sync; no extra work required.
                return true;
            });
        });
    </script>

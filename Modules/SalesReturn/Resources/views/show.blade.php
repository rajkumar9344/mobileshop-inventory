            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex flex-wrap align-items-center">
                        ...
                        <div class="ml-auto">
                            <a href="{{ route('sale-returns.index') }}" class="btn btn-sm btn-outline-secondary mr-2">
                                <i class="bi bi-arrow-left"></i> Back
                            </a>
                            <a target="_blank" class="btn btn-sm btn-secondary mr-2 d-print-none" href="{{ route('sale-returns.pdf', $sale_return->id) }}">
                                <i class="bi bi-printer"></i> Print
                            </a>
                            <a target="_blank" class="btn btn-sm btn-info d-print-none" href="{{ route('sale-returns.pdf', $sale_return->id) }}">
